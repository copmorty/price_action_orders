                    ...
                    : Scrollbar(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final dateTime = new DateTime.fromMillisecondsSinceEpoch(ordersState.openOrders[index].time);
                            final side = ordersState.openOrders[index].side.capitalize();
                            final filledQty =
                                ordersState.openOrders[index].executedQty / ordersState.openOrders[index].origQty * Decimal.parse('100');
                            final total = ordersState.openOrders[index].price * ordersState.openOrders[index].origQty;
                            final triggerConditions = ordersState.openOrders[index].stopPrice == Decimal.zero
                                ? '-'
                                : '<= ' + ordersState.openOrders[index].stopPrice.toString();
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                WallTableCell(label: ordersState.openOrders[index].type.capitalizeWords()),
                                WallTableCell(
                                    label: side, style: TextStyle(color: side == 'Buy' ? Colors.green : Colors.red, fontWeight: FontWeight.w500)),
