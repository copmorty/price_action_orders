...
// in price_action_orders/test/presentation/logic/tickerstats_state_notifier_test.dart.
...
import 'package:price_action_orders/domain/entities/ticker_stats.dart' as _i11;
...
/// A class which mocks [GetTickerStatsStream].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetTickerStatsStream extends _i1.Mock
    implements _i10.GetTickerStatsStream {
  MockGetTickerStatsStream() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.Future<_i3.Either<_i7.Failure, _i6.Stream<_i11.TickerStats>>> call(
          _i10.Params? params) =>
      (super.noSuchMethod(Invocation.method(#call, [params]),
          returnValue: Future<
                  _i3.Either<_i7.Failure, _i6.Stream<_i11.TickerStats>>>.value(
              _FakeEither<_i7.Failure, _i6.Stream<_i11.TickerStats>>())) as _i6
          .Future<_i3.Either<_i7.Failure, _i6.Stream<_i11.TickerStats>>>);
}
