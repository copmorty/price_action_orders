...
import 'package:price_action_orders/core/utils/datasource_utils.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockDataSourceUtils extends _i1.Mock implements _i7.DataSourceUtils {
  MockDataSourceUtils() {
    _i1.throwOnMissingStub(this);
  }
...
class MockHttpClient extends _i1.Mock implements _i8.Client {
  ...
  @override
  _i2.Future<_i10.Uint8List> readBytes(Uri? url,
          {Map<String, String>? headers}) =>
      (super.noSuchMethod(
  ...
  @override
  _i2.Future<_i5.StreamedResponse> send(_i11.BaseRequest? request) =>
